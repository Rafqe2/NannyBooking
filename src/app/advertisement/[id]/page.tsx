              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="bg-gradient-to-br from-brand-50 to-brand-50 px-6 py-5 text-center border-b border-gray-100">
                  ...
                  >
                    {owner?.picture ? (
                      <>
                        <Image src={owner.picture} alt={`${owner.fullName} avatar`} width={80} height={80} className="w-full h-full object-cover" />
      ...
      {showOwnerPhoto && owner?.picture && (
        ...
        >
          <div className="relative max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
            <Image src={owner.picture} alt={`${owner.fullName} photo`} width={400} height={400} sizes="(max-width: 640px) 90vw, 400px" className="w-full h-auto rounded-2xl object-cover shadow-2xl" />
            <button
              onClick={() => setShowOwnerPhoto(false)}
